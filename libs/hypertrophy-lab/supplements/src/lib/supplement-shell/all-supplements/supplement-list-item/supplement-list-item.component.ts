...
import { DividerComponent, DoughnutComponent, TagComponent, TagGroupComponent } from '@ikigaidev/elements';
...
@Component({
  ...
  imports: [TagComponent, TagGroupComponent, TitleCasePipe, DoughnutComponent, DividerComponent],
})
